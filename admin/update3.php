...
{
	$sno=$_GET['x'];
	$sel="select * from notes where sno='$sno'";
...
if(isset($_POST['sub']))
{
	...
	$type=$_POST['type'];
	$file=$_POST['file'];
$x="update notes set Name='$user',category='$category',sub_category='$sub_category',type='$type',file='$file' where sno='$sno'";
$y=mysqli_query($con,$x);
if($y)
{
	header("location:view update for notes.php");
}
else
{
	echo"not updated";
